        ...
        stage('Build and Push Docker Image') {
            steps {
                script {
                    ...
                    sh """
                    docker build . -t $DOCKER_REGISTRY/${env.REGISTRY_USER}/$DOCKER_IMAGE:latest -f ./docker/Dockerfile
                    docker push $DOCKER_REGISTRY/${env.REGISTRY_USER}/$DOCKER_IMAGE:latest
                    """
                }
            }
        }
